...
namespace ProjectDb.Migrations
{
    ...
    [Migration("20241219122531_CustomerCaseInitial")]
    partial class CustomerCaseInitial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectDb.Models.CustomerCase", b =>
                {
                    ...
                    b.Property<byte[]>("Media1")
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("Media2")
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("Media3")
                        .HasColumnType("varbinary(max)");

                    b.Property<int?>("Priority")
                        .HasColumnType("int");

                    b.HasKey("CustomerCode", "UserCode");
            ...
            modelBuilder.Entity("ProjectDb.Models.CustomerCase", b =>
                {
                    b.HasOne("ProjectDb.Models.AuthorizedPerson", "AuthorizedPerson")
                        .WithMany()
                        .HasForeignKey("AuthorizedPersonId");

                    b.HasOne("ProjectDb.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId");

                    b.HasOne("ProjectDb.Models.Login", "Login")
                        .WithMany()
